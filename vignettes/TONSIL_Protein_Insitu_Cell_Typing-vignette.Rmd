...
```{r setup}
devtools::load_all("/home/rstudio/sawoo/smidaSMICellTyping_SS_V2_1/",export_all=FALSE)
# library(InSituType)
...
sig_mat = read.csv(paste0(system.file("extdata", package="smiProtein"), "/default_signature_matrix.csv"))
