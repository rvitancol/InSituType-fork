...
* New function `spatialUpdate` for using alternative data types (e.g. space or immunofluorescence) and the Insitutype likelihood framework to update cell typing results from any method. New function `getSpatialContext` for conveniently calculating cells' spatial contexts / neighborhood expression. 
